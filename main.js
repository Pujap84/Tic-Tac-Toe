...
for (let i = 0; i < allDivs.length; i++) {
    allDivs[i].addEventListener("click", gamePlay);
}
...
function gamePlay(event) {
    ...
    if (
        allTheSameRow1 === false &&
        allTheSameRow2 === false &&
        allTheSameRow3 === false &&
        allTheSameColumn1 === false &&
        allTheSameColumn2 === false &&
        allTheSameColumn3 === false &&
        allTheSameDiagonal1 === false &&
        allTheSameDiagonal2 === false &&
        boxesAreFull
    ) {
        for (let i = 0; i < allDivs.length; i++) {
            allDivs[i].removeEventListener("click", gamePlay);
        }
        setTimeout(function () {
            alert("Its a draw! Restart the game"); // to delay the alert
        }, 200);
    ...
    if (allTheSame == true) {
        setTimeout(function () {
            ...
            document.querySelector(".gameWinner").textContent =
                "The Winner is " + playerValue + "!";
            document.querySelector(".gameWinner").style.color = "greenYellow";
            document.querySelector(".gameWinner").style.fontSize = "40px";
            document.querySelector(".gameWinner").style.animation =
                "blinking 4s infinite linearx ";
...
restartBtn.addEventListener("click", function () {
    ...
    document.querySelector("#message").textContent =
        "Player 1 Choose your Value";
    document.querySelector(".gameBoard div").textContent = "";
    document.querySelector(".gameWinner").textContent = "The Winner is...";
    document.querySelector(".gameWinner").style.color = "turquoise";
    document.querySelector(".gameWinner").style.fontSize = "25px";
    for (let i = 0; i < allDivs.length; i++) {
